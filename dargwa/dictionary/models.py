...
class Morpheme(models.Model):
    ...
    morph_type = models.ForeignKey('MorphemeType', on_delete=models.CASCADE)
    number = models.ForeignKey('MorphemeNumber', on_delete=models.CASCADE, null=True, blank=True)
    word = models.ForeignKey('Word', on_delete=models.CASCADE)
